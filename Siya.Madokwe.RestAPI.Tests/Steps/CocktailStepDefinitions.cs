...
namespace Siya.Madokwe.RestAPI.Tests.Steps
{
    ...
    public class CocktailStepDefinitions
    {
        ...
        public void GivenIWantToSearchCocktailUsing(string vodka)
        {
            ...
            _featureContext[Constants.Name] = vodka;
            _featureContext[Constants.CocktailDbResponse] = response.Data;
        ...
        public void GivenIVerifySearchResultMatch()
        {
            ...
            var cocktailDbResponse = (CocktailDbResponse)_featureContext[Constants.CocktailDbResponse];
